...
export default {
  ...
  data() {
    return {
      ...
      fromAccountRules: [
        ...transactionFormValidation.fromAccountRules,
        (value) => this.validateFromAccountRules(value),
      ],
      toAccountRules: [
        ...transactionFormValidation.toAccountRules,
        (value) => this.validateToAccountRules(value),
      ],
